...
public class PlayerFragmentTV extends DetailsFragment {
    private static final String TAG = "PlayerFragmentTV";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDorPresenter.setSharedElementEnterTransition(getActivity(),
                PlayerActivityTV.SHARED_ELEMENT_NAME);
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            if (item instanceof Movie) {
                ...
                Intent intent = new Intent(getActivity(), PlayerActivityTV.class);
                intent.putExtra(PlayerActivityTV.MOVIE, movie);

                Bundle bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        getActivity(),
                        ((ImageCardView) itemViewHolder.view).getMainImageView(),
                        PlayerActivityTV.SHARED_ELEMENT_NAME).toBundle();
